          ...
          <div className="max-w-3xl">
            ...
            <div className="space-y-4">
              <div className="inline-block bg-orange-500/50 px-6 py-3 rounded-full text-white backdrop-blur-sm">
                <span className="font-bold">Early Bird Special:</span> ₹999/- (till 9th March)
              </div>
              <div className="block">
                <span className="text-gray-300 px-6 py-3">Regular Fee:</span> ₹1,499/- (after 9th March)
              </div>
